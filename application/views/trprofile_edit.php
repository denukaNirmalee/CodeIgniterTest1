...
<form class="prof">
    ...
    <table>
            ...
            if($viewtrprofile->num_rows()>0)
            {
                foreach ($viewtrprofile->result()as $row)
                {
                    ...
                    <div class="col-sm-5"><input type="text" value=" <?php echo $row->trname?>"></div>
                    </div><br><br>
    ...
    <a href="<?php echo base_url();?>main/update_profile/<?php echo $this-> session->userdata('username');?>">EDIT</a>
